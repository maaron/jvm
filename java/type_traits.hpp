...
type_traits<void>::jni_type type_traits<void>::call_method(JNIEnv* env, jobject obj, jmethodID id, va_list args) { return env->CallVoidMethodV(obj, id, args); }
type_traits<void>::jni_type type_traits<void>::call_static_method(JNIEnv* env, jclass cls, jmethodID id, va_list args) { return env->CallStaticVoidMethodV(cls, id, args); }

type_traits<jobject>::jni_type type_traits<jobject>::call_method(JNIEnv* env, jobject obj, jmethodID id, va_list args) { return env->CallObjectMethodV(obj, id, args); }
type_traits<jobject>::jni_type type_traits<jobject>::call_static_method(JNIEnv* env, jclass cls, jmethodID id, va_list args) { return env->CallStaticObjectMethodV(cls, id, args); }

#define def_primitive_type_traits(jtype, cap_name) \
type_traits<jtype>::jni_type type_traits<jtype>::call_method(JNIEnv* env, jobject obj, jmethodID id, va_list args) { return env->Call##cap_name##MethodV(obj, id, args); } \
type_traits<jtype>::jni_type type_traits<jtype>::call_static_method(JNIEnv* env, jclass cls, jmethodID id, va_list args) { return env->CallStatic##cap_name##MethodV(cls, id, args); } \
